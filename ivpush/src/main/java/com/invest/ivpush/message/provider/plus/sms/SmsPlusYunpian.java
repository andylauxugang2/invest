...
import com.invest.ivpush.message.provider.plus.sms.bean.SmsCode;
...
public class SmsPlusYunpian implements SmsMessagePlus {
    ...
    // 通用发送接口的http地址
    private String uriGetTppl;

    @Value(value = "${yunpian.uri.send_sms.send}")
    ...
    public String getUserInfo(String apikey) throws IOException, URISyntaxException {
        ...
        return post(uriGetUserInfo, params);
    }
