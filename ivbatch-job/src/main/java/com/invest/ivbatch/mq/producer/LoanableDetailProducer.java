package com.invest.ivbatch.mq.producer;
 ...
 */
public class LoanableDetailProducer implements MQProducer<LoanableDetailMessage> {
    private static final Logger logger = LoggerFactory.getLogger(LoanableDetailProducer.class);

    @Resource
    private DefaultMQProducer ivbatchMQProducer;
    ...
    public boolean sendMsg(LoanableDetailMessage msg) {
        ...
        try {
            ...
            SendResult sendResult = ivbatchMQProducer.send(message);
