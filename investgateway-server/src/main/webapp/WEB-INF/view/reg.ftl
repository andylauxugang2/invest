        ...
        <div class="andy-panel andy-panel-user" style="padding: 20px;">
            <div class="layui-tab layui-tab-brief">
                <ul class="layui-tab-title">
                    <li class="layui-this"><a href="/register">新用户注册</a></li>
                    ...
                    <div class="layui-tab-item layui-show">
                        <div class="layui-form layui-form-pane">
                            <form method="post">
                                ...
                                <div class="layui-form-item">
                                    <button class="layui-btn" lay-filter="regfilter" lay-submit>立即注册</button>
                                </div>

                                <div class="layui-form-item andy-form-app">
                                    <span>或者直接使用社交账号快捷注册</span>
                                    <a href="http://www.17ppd.com:8098/app/qq"
                                       onclick="layer.msg('正在通过QQ登入', {icon:16, shade: 0.1, time:0})" title="QQ登入">
                                        <i class="iconfont icon-qq"></i>
                                    </a>
                                    <a href="http://www.17ppd.com:8098/app/weibo/"
                                       onclick="layer.msg('正在通过微博登入', {icon:16, shade: 0.1, time:0})" title="微博登入">
...
<script src="/res/mods/reg.js"></script>
</body>
</html>
