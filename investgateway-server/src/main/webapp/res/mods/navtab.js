...
layui.define(['element'], function(exports){
   var  element = layui.element,
        ...
        LarryTab.prototype.tabAdd = function(data){
		    ...
		    if(tabIndex === -1){
		    	globalTabIdIndex++;
		    	var content = '<iframe src="' + data.href + '" data-id="' + globalTabIdIndex + '" style="width: 100%;border: 0;height: 100%;"></iframe>';
			    var title = '';
			    // 若icon有定义
			    if(data.icon){
			    ...
			    title += '<em style="margin-left: 5px;">' + data.title + '</em>';
		    	...
		    	ELEM.contentBox.find('iframe[data-id=' + tabIndex + ']').attr("src", data.href);
