package com.invest.ivppad.util.netty;
...
public class NettyClient {
    public static HttpRequest getRequestMethod(Map<String, String> parameter, String url, String method, Map<String, Object> headerMap) throws HttpPostRequestEncoder.ErrorDataEncoderException {
        URI uri;
        try {
            uri = new URI(url);
...
//            request.headers().set(HttpHeaders.Names.ACCEPT_ENCODING, HttpHeaders.Values.GZIP);
    ...
    public static void main(String args[]) throws HttpPostRequestEncoder.ErrorDataEncoderException, InterruptedException {
        ...
        HttpRequest get = getRequestMethod(getData, url, "post", null);
